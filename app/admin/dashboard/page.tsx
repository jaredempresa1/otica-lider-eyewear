...
export default function AdminDashboardPage() {
  ...
  function openEditForm(product: Product) {
    setForm({
      ...
      specAiTryOn: Boolean(product.specifications?.ai_try_on),
