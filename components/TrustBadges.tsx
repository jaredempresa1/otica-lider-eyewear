...
const BADGES = [
  { icon: Truck, title: "Frete grátis", description: "João Pessoa e Goiana. Demais regiões, frete combinado." },
  { icon: CreditCard, title: "Pagamento facilitado", description: "Pix, cartão ou parcelamento direto com você." },
