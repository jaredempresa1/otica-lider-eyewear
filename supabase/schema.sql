...
-- =========================================================
-- SLIDES DO CARROSSEL PRINCIPAL (topo da home)
-- =========================================================
-- Substitui a lista fixa que existia antes no componente Hero. Cada linha é
-- um slide: foto (retrato p/ mobile + widescreen p/ desktop) OU vídeo, com
-- destino opcional de clique (coleção, produto, ou um atalho de filtro como
-- "Óculos Feminino", "Sport Vision", "Ofertas" etc.).
